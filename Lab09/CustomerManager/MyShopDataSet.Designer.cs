...
namespace CustomerManager {
    ...
    public partial class MyShopDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string Name, string Email, int Age, byte[] Photo) {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerId] = @Original_CustomerId) AND ([" +
                ...
                " = @Original_Email)) AND ([Age] = @Original_Age))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Name], [Email], [Age], [Photo]) VALUES (@Name, @E" +
                "mail, @Age, @Photo);\r\nSELECT CustomerId, Name, Email, Age, Photo FROM Customers " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Name] = @Name, [Email] = @Email, [Age] = @Age, [Photo] = @Photo WHERE (([CustomerId] = @Original_CustomerId) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Age] = @Original_Age));
SELECT CustomerId, Name, Email, Age, Photo FROM Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, Name, Email, Age, Photo FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_CustomerId, string Original_Name, string Original_Email, int Original_Age) {
        ...
        public virtual int Insert(string Name, string Email, int Age, byte[] Photo) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, int Age, byte[] Photo, int Original_CustomerId, string Original_Name, string Original_Email, int Original_Age, int CustomerId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, int Age, byte[] Photo, int Original_CustomerId, string Original_Name, string Original_Email, int Original_Age) {
            return this.Update(Name, Email, Age, Photo, Original_CustomerId, Original_Name, Original_Email, Original_Age, Original_CustomerId);
        }
    }
