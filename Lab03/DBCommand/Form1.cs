    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (sqlConnection1)
            {
                try
                {
                    ...
                    Console.WriteLine("1 --- " + sqlConnection1.ConnectionString);
                    sqlConnection1.Open(); 
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (sqlConnection1)
            {
                ...
                {
                    bool MoreResults = false;
                    Console.WriteLine("2 --- " + sqlConnection1.ConnectionString);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder(); using (sqlConnection1)
            {
                try
                {
                    sqlConnection1.Open(); SqlDataReader reader = sqlCommand2.ExecuteReader();
                    while (reader.Read()) 
                    {
                        for (int i = 0; i < reader.FieldCount; i++) 
                        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            using (sqlConnection1) 
            { 
                sqlCommand3.CommandText = "CREATE TABLE SalesPersons (" + "[SalesPersonID] [int] IDENTITY(1,1) NOT NULL, " + "[FirstName] [nvarchar](50) NULL, " +
