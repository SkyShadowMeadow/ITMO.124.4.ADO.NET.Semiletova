...
namespace DBConnection
{
    public partial class Form1 : Form
    {
        ...
        private void connection_StateChange(object sender, StateChangeEventArgs e)
        {
            ...
            ассинхронноеПодключениеToolStripMenuItem.Enabled = (e.CurrentState == ConnectionState.Closed);
        ...
        private async void ассинхронноеПодключениеToolStripMenuItem_Click(object sender, EventArgs e)
        {
                try
                {
                    if (connection.State != ConnectionState.Open)
